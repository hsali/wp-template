...
<!-- inner page banner -->
   ...
   ?>
  <div class="banner-inner-row sf-overlay-wrapper" style="background-image:url(<?php echo esc_url($bannerimg); ?>);">
